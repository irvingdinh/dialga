...
- Always test your implementation with `playwright-cli`. All assets, including snapshots, screenshots, and downloads, must be placed inside the gitignored `.playwright-cli` folder.
